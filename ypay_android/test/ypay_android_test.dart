...
void main() {
  ...
  setUp(() {
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        .setMockMethodCallHandler(paymentChannel, ypayMockMethodCallHandler);
  });
  ...
  test(
    ...
    () async {
      ...
      expect(
          () async => YPayPlatform.instance.init(configuration: invalidConfig),
          throwsA(isA<YPayInitializeError>()));
    },
  );
  test(
    'startPayment()',
  ...
  test(
    ...
    () async {
      const invalidURL = '';
      expect(() async => YPayPlatform.instance.startPayment(url: invalidURL),
          throwsA(isA<YPayValidationError>()));
    },
  );
}
