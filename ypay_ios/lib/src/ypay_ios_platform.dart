...
/// An [YPayPlatform] that wraps YPay iOS SDK.
class YPayIosPlatform extends YPayPlatform {
  YPayIosPlatform._();

  final YPayMethodHandler _methodHandler = YPayMethodHandler();
  ...
  static void registerPlatform() {
    ...
    YPayPlatform.instance = YPayIosPlatform._();
  }
